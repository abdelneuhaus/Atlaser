...
def crop_from_dapi(prms, res=4):
    ...
    """
    Crop all the related files, listed in the parameter dictionary recovered from an ndpis file based on the dapi channel (dapi has to be in the name of one image)
